 ...
 */
Promise.prototype.fy = function (callback) {
...
module.exports = {
  ...
  goodsDetail: function goodsDetail(id,token) {
  ...
  goodsPrice: function goodsPrice(goodsId, propertyChildIds,token) {
    return request('/shop/goods/price', true, 'post', {
      goodsId: goodsId, propertyChildIds: propertyChildIds,token
    });
  },
